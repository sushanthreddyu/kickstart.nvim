...
do
  ...
  -- Map it to open the directory of your current file
...
do
  ...
  require('mason').setup {
    -- The nvim-java registry is listed first so its packages (jdtls, java-test,
    -- java-debug-adapter, spring-boot-tools) win over the default registry.
    registries = {
